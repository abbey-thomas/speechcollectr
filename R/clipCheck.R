...
#' @param return Either "df" or "logical". Should the function return a dataframe containing a list of clipped frames or just a logical value indicating whether more samples than the amount indicated by `max_clipped` were clipped?
